...
public class ProductServiceTests {
    ...
    void setUp() throws Exception {
        ...
        Mockito.doThrow(DataIntegrityViolationException.class).when(repository).deleteById(dependedId);
    }
    ...
    public void deleteShouldThrowDatabaseExceptionWhenDependentId() {
        ...
        Mockito.verify(repository, Mockito.times(1)).deleteById(dependedId);
    }
